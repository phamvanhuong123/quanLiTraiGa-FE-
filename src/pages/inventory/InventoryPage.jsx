...
//     setData(res.data || []);
//   } catch {
//     message.error("Không tải được dữ liệu kho");
//   } finally {
//     setLoading(false);
//   }
// };
...
//     return result;
//   }, [data, materialFilter, onlyExpiring]);
...
//           <Space>
//             <InventoryFilters data={data} onChange={setMaterialFilter} />
//             <Space>
//               <Switch checked={onlyExpiring} onChange={setOnlyExpiring} />
...
//       ) : (
//         <InventoryTable data={filteredData} loading={loading} />
//       )}
