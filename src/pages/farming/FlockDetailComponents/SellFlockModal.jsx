      ...
      <Form form={form} layout="vertical" preserve={false}>
            ...
            message={
              <div>
                ...
                <div style={{ marginTop: 4 }}>
                  Số lượng hiện tại:{" "}
                  <Tag color="blue">{flock?.currentQuantity}</Tag> con
                </div>
              </div>
            }
            type="info"
              ...
              validator: (_, value) => {
                if (
                  ...
                  return Promise.reject(
                    new Error("Số lượng bán phải là số nguyên"),
                  );
                }
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          >
            ...
            <Tag
              color={remainingChickens > 0 ? "orange" : "green"}
        ...
        <div
          style={{ padding: 16, backgroundColor: "#fafafa", borderRadius: 6 }}
        >
          <div
            style={{
              display: "flex",
            ...
            <div>
              ...
              <div style={{ fontSize: 14, color: "#666" }}>
                {closeFlock ? (
                  ...
                  <span>Đàn vẫn tiếp tục nuôi với số gà còn lại</span>
                )}
              </div>
            </div>
            <Switch
